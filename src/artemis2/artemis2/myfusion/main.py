...
def main(args):
    ...
    elif args.model == 'vjepa_artemis':
        from models.vjepa_artemis import VJEPAARTEMISExecutor
        executor = VJEPAARTEMISExecutor(*model_args)
    elif args.model == 'videomae_artemis':
        from models.videomae_artemis import VideoMAEArtemisExecutor
        executor = VideoMAEArtemisExecutor(*model_args)
        # FOR TRANSFER LEARNING
        # executor.load('artemis2_model_contrastive/artemis_vm_dino_s4_align_cosine_variation1_conv_residual_backboneresidual_imageresidual_.pth')
    elif args.model == 'videomae_artemis_contrastive':
        from models.videomae_artemis_contrastive import VideoMAEArtemisContrastiveExecutor
        executor = VideoMAEArtemisContrastiveExecutor(*model_args)
    elif args.model == 'videomamba_artemis':
        from models.videomamba_artemis import VideoMambaArtemisExecutor
        executor = VideoMambaArtemisExecutor(*model_args)
    elif args.model == 'mambamsqnetvariation1':
        from models.mambamsqnet_variation1 import MambaMSQNetVariation1Executor
        executor = MambaMSQNetVariation1Executor(*model_args)
