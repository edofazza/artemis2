...
from torchmetrics.classification import MultilabelAveragePrecision, MulticlassAccuracy
...
class Ensemble(object):
    def __init__(self, models, data_loader, device, num_labels):
        ...
        #self.eval_metrics = MulticlassAccuracy(num_classes=num_labels, average='micro').to(device)
        self.device = device
