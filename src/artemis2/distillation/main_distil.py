...
def main(args):
    ...
    model1.load_state_dict(torch.load('artemis2_model_contrastive/artemis_vm_dino_s4_align_cosine_variation1_conv_residual_backboneresidual_imageresidual_.pth'))
    ...
    model2.load_state_dict(torch.load('artemis2_model_contrastive/artemis_vm_dino_s4_flava_cosine_variation1_conv_residual_backboneresidual_imageresidual_.pth'))
    ...
    model3.load_state_dict(
        torch.load('artemis2_model_contrastive/artemis_bilstm_vm_dino_s4_align_best_cosine_variation1_bilstm_residual_sumresidual_backboneresidual_linear2residual_imageresidual_.pth'))
    ...
    executor.save(f'distillation2/{args.name}')
